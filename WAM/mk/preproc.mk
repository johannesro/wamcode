OBJECTS = wam_special_module.o wam_model_module.o wam_mpi_module.o wam_file_module.o wam_general_module.o wam_timopt_module.o wam_fre_dir_module.o \
...
preproc:
	#mpxlf90 $(OBJECTS) -o preproc
	ifort -o preproc $(OBJECTS) -lmpi
