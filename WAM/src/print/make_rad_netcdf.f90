program make_rad_netcdf

! ---------------------------------------------------------------------------- !
!                                                                              !    
!     *make_netcdf* - change output from binary format to NetCDF    ---------- !
!                                                                              !
!     A. Behrens    Helmholtz-Zentrum Geesthacht       June 2014    ---------- !
!                                                                              !
! ---------------------------------------------------------------------------- !
!
!     PURPOSE.
...
!       PRINTS FIELDS OF RADIATION STRESS DATA
!
!     REFERENCE.
!     ----------
!
...
!use wam_rad_netcdf_module

use wam_rad_netcdf_metno_module
...
integer            :: iu06 = 6
integer            :: nout_p = 8
character (len=80) :: file05 = 'NETCDF_RAD_User'
character (len=80) :: file06 = 'pnetcdf_rad_prot'
