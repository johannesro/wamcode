OBJECTS = wam_mpi_module.o wam_file_module.o wam_timopt_module.o \
...
pnetcdf:
	#mpxlf90 $(OBJECTS) -o pnetcdf -qextname -q64 -L/sw/aix61/netcdf-4.1.1-rc1/lib -lnetcdf -L/sw/aix61/hdf5-1.8.4-patch1/lib -lhdf5 -lhdf5_hl -L/sw/aix53/szip-2.1/lib -lsz -L/sw/aix53/zlib-1.2.3/lib -lz -lm
	ifort -o pnetcdf $(OBJECTS) -lnetcdff -lnetcdf -lmpi
